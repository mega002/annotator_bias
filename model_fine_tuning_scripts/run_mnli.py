...
flags.DEFINE_bool(
    ...
    "Whether to use top 5 annotator ids as labels "
    "(+ other label for all other annotators).")
...
class MnliProcessor(DataProcessor):
  ...
  def __init__(self, split, annotator_idx, augment_ratio, take_number, annotator_labels):
  ...
  def get_labels(self):
    ...
    if self.annotator_labels:
        # These are anonymized annotator IDs.
        return ["ANNOT1", "ANNOT2", "ANNOT3", "ANNOT4", "ANNOT5", "OTHER"]
    else:
  ...
  def _create_examples(self, lines, set_type):
    ...
    for i, line in enumerate(lines):
        guid = tokenization.convert_to_unicode(line["pairID"])
...
def main(_):
  ...
  processor = MnliProcessor(split=FLAGS.split, annotator_idx=FLAGS.annotator_idx,
                            augment_ratio=FLAGS.augment_ratio, take_number=FLAGS.take_number,
                            annotator_labels=FLAGS.annotator_labels)
